...
@.str.9 = private unnamed_addr constant [66 x i8] c"/u1/dtompkins/.seashell/projects/_cs136tools/common/cs136-trace.c\00", align 1
...
if.else:                                          ; preds = %if.then2
  call void @__assert_fail(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.8, i64 0, i64 0), i8* getelementptr inbounds ([66 x i8], [66 x i8]* @.str.9, i64 0, i64 0), i32 70, i8* getelementptr inbounds ([90 x i8], [90 x i8]* @__PRETTY_FUNCTION__._TRACE_ARR, i64 0, i64 0)) #7
  unreachable
...
if.else7:                                         ; preds = %if.end4
  call void @__assert_fail(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.10, i64 0, i64 0), i8* getelementptr inbounds ([66 x i8], [66 x i8]* @.str.9, i64 0, i64 0), i32 71, i8* getelementptr inbounds ([90 x i8], [90 x i8]* @__PRETTY_FUNCTION__._TRACE_ARR, i64 0, i64 0)) #7
  unreachable
